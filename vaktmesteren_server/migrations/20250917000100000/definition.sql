...
--
-- Class PersistedAlertState (repair migration) as table persisted_alert_state
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('vaktmesteren', '20250917000100000', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250917000100000', "timestamp" = now();
